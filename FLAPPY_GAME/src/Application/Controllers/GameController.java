...
public class GameController {
    ...
    @FXML private Button showTopScoresButton;
    ...
    public void initialize() {
        ...
        showTopScoresButton.setOnAction(e -> showTopScores());
    ...
    private void resetGame() {
        ...
        showTopScoresButton.setVisible(false);
    ...
    private void showTopScores() {
        List<String> topScores = dbManager.getTopScores(5);
        Alert alert = new Alert(Alert.AlertType.INFORMATION);
        alert.setTitle("Top 5 Scores");
        alert.setHeaderText("Highest Scores:");
    ...
    private void update() {
        ...
        if (birdY > gameCanvas.getHeight() - birdRadius || birdY < birdRadius) {
            endGame();
            return;
        }
    ...
    private void endGame() {
        ...
        showTopScoresButton.setVisible(true);
    }
